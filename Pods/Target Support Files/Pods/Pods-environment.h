...
// JsonSwiftson
#define COCOAPODS_POD_AVAILABLE_JsonSwiftson
#define COCOAPODS_VERSION_MAJOR_JsonSwiftson 1
#define COCOAPODS_VERSION_MINOR_JsonSwiftson 0
#define COCOAPODS_VERSION_PATCH_JsonSwiftson 0
